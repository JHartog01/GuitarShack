...
class GuitarShackIntegrationTests: XCTestCase {
    ...
    func testNotificationIsSent() {
        ...
        let reorderChecker: ReorderChecker = ReorderChecker(notification, ProductWarehouse(baseURL: "https://6hr1390c1j.execute-api.us-east-2.amazonaws.com/", network: Network()), ReorderCalculator(ThirtyDayAverageSales(ProductSalesHistory(baseUrl: "https://gjtvhjg8e9.execute-api.us-east-2.amazonaws.com/", network: Network()), StubCurrentDate())))
